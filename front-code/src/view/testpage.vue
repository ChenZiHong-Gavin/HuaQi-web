<template>
  <div class="test">
     ...
     <div style="background:#eee;padding: 20px">
        ...
        <Radio label="value3_2">
        <span>b.15万-30万元</span>
        </Radio>
        <Radio label="value3_3">
        <span>c.30万-50万元</span>
        </Radio>
        <Radio label="value3_4">
        <span>d.50万-100万元</span>
        </Radio>
        <Radio label="value3_5">
        <span>e.100万元以上</span>
        </Radio>
        </RadioGroup>
        </Card>
     ...
     <div style="background:#eee;padding: 20px">
        ...
        <Radio label="value4_2">
        <span>b.200-500万</span>
        </Radio>
        <Radio label="value4_3">
        <span>c.500万-1000万</span>
        </Radio>
        <Radio label="value4_4">
        <span>d.1000万-3000万</span>
        </Radio>
        <Radio label="value4_5">
        <span>e.3000万以上</span>
        </Radio>
        </RadioGroup>
        </Card>
     ...
     <div style="background:#eee;padding: 20px">
        ...
        <Radio label="value5_2">
        <span>b.1-3年</span>
        </Radio>
        <Radio label="value5_3">
        <span>c.3-5年</span>
        </Radio>
        <Radio label="value5_4">
        <span>d.5年以上</span>
        </Radio>
        </RadioGroup>
        </Card>
     ...
     <div style="background:#eee;padding: 20px">
        ...
        <Radio label="value6_2">
        <span>b.15%-30%</span>
        </Radio>
        <Radio label="value6_3">
        <span>c.30%-50%</span>
        </Radio>
        <Radio label="value6_4">
        <span>d.50%以上</span>
        </Radio>
        </RadioGroup>
        </Card>
     ...
     <div style="background:#eee;padding: 20px">
        ...
        <Radio label="value9_2">
        <span>b.30岁-40岁</span>
        </Radio>
        <Radio label="value9_3">
        <span>c.40岁-55岁</span>
        </Radio>
        <Radio label="value9_4">
        <span>d.55岁以上</span>
        </Radio>
        </RadioGroup>
        </Card>
     ...
     <div style="background:#eee;padding: 20px">
        ...
        <Radio label="value10_2">
        <span>b.情绪低落，感到遗憾</span>
        </Radio>
        <Radio label="value10_3">
        <span>c.判断失误，权当学费</span>
        </Radio>
        <Radio label="value10_4">
        <span>d.有盈有亏，正常</span>
        </Radio>
        </RadioGroup>
        </Card>
     ...
     <div style="background:#eee;padding: 20px">
        ...
        <Radio label="value11_2">
        <span>b.5%-10%</span>
        </Radio>
        <Radio label="value11_3">
        <span>c.10%-30%</span>
        </Radio>
        <Radio label="value11_4">
        <span>d.>30%</span>
        </Radio>
        </RadioGroup>
        </Card>
        ...
        <Radio label="value12_2">
        <span>b.获得一定增值，同时波动适度的年回报</span>
        </Radio>
        <Radio label="value12_3">
        <span>c.注重长期收益，对短期盈亏不敏感</span>
        </Radio>
        <Radio label="value12_4">
